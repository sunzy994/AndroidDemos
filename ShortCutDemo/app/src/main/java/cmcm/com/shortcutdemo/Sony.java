...
public class Sony {
    ...
    private boolean checkReadPermissionLauncher(String launcher, String shortcutIntent) {
        ...
        int ver = android.os.Build.VERSION.SDK_INT;
        String AUTHORITY = "com.sonymobile.home.configprovider";//parseFirstAUTHORITY2(context, launcher);
        if (TextUtils.isEmpty(AUTHORITY)) {
            if (ver < 8) {
                AUTHORITY = "com.android.launcher.settings";
            } else {
    ...
    private boolean checkUriExist(Uri uri, String shortcutIntent) {
        ...
        try {
            ...
            do {
                ...
                Logger.v("pkg = " + cursor.getString(cursor.getColumnIndex("packageName")));
