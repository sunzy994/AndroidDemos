...
public class pb
{
  public static void a(InputStream paramInputStream, String paramString1, String paramString2)
  {
    ...
    while (true)
    {
      ...
      {
        ov.a(paramInputStream);
      }
      if (!((File)localObject).getParentFile().exists())
        ((File)localObject).getParentFile().mkdirs();
      ov.a(paramInputStream, (File)localObject);
    }
    ov.a(paramInputStream);
  }
  ...
  public static void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    //   3: dup
    //   4: aload_0
    //   5: invokespecial 64	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   8: astore_3
    //   9: aload_3
    //   10: aload_1
    //   11: aload_2
    //   12: invokestatic 66	pb:a	(Ljava/io/InputStream;Ljava/lang/String;Ljava/lang/String;)V
    //   15: aload_3
